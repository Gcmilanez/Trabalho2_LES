...
int main(int argc, char** argv) {
    std::cout << "========================================================\n";
    std::cout << "   Random Forest: Implementacao Otimizada (Energia)\n";
    std::cout << "========================================================\n\n";
    ...
    // Hiperparametros (pode ajustar, mas mantenha fixos entre testes)
    const int n_trees           = 32;  // ex.: menos arvores, mais "baratas"
    const int max_depth         = 8;
    const int min_samples_split = 5;
    const int chunk_size        = 100; // alinhado com sua DecisionTree
    ...
    for (int run = 0; run < num_runs; ++run) {
        ...
        std::cout << "  Treinando RandomForestOptimized... ";
